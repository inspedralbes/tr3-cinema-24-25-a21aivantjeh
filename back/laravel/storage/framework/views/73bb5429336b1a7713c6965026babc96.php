...
<head>
    ...
    <title><?php echo e($subject ?? 'Bienvenido a TaquillaXpress'); ?></title>
    <style>
        /* Estilos base */
        * {
            margin: 0;
...
<body>
    <div class="container">
        <div class="card">
            ...
            <div class="content">
                <p class="greeting">
                    Hola, <span class="name"><?php echo e($user['name']); ?> <?php echo e($user['surname']); ?></span>
                </p>
                ...
                <div class="button-container">
                    <a href="<?php echo e(url('comprar-entradas')); ?>" class="button">
                        🎬 Descubrir películas
                    </a>
                </div>
            ...
            <div class="footer">
                <p class="copyright">
                    &copy; <?php echo e(date('Y')); ?> TaquillaXpress. Todos los derechos reservados.
                </p>
            </div>
        </div>
    </div>
